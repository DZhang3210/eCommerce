...
export async function emailOrderHistory(prevState: unknown, formData: FormData): Promise<{ message?: string; error?: string }> {
    ...
    if (user == null) {
        return {
            message:
                "Check your email to view your order history and download the products."
        }
    }
    ...
    const data = await resend.emails.send({
        ...
        react:
            <OrderHistory orders={await Promise.all(orders)} />
    })
    ...
    return { message: "Check your email to view your order history and download the products." }
}